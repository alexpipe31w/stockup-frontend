...
export default function WhatsAppPage() {
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold text-txt-primary mb-1">WhatsApp</h1>
      <p className="text-txt-secondary mb-8">Conecta tu número de WhatsApp para activar el bot</p>

      <div className="bg-surface rounded-2xl border border-border-subtle shadow-sm p-8 flex flex-col items-center gap-6">
        ...
        {connected ? (
          <>
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <p className="text-txt-primary font-medium">Tu WhatsApp está activo</p>
              <p className="text-txt-tertiary text-sm">El bot está respondiendo mensajes automáticamente</p>
            </div>
            ...
            {!qr ? (
              <>
                <div className="flex flex-col items-center gap-2 text-center">
                  ...
                  <p className="text-txt-primary font-medium">WhatsApp no conectado</p>
                  <p className="text-txt-tertiary text-sm">Haz clic en conectar para generar el código QR</p>
                </div>
              ...
              <>
                <div className="text-center">
                  <p className="text-txt-primary font-medium mb-1">Escanea este código QR</p>
                  <p className="text-txt-tertiary text-sm">Abre WhatsApp → Dispositivos vinculados → Vincular dispositivo</p>
                </div>

                <div className="bg-surface border-2 border-border-subtle rounded-xl p-4 flex items-center justify-center">
