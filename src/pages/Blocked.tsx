  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-txt-primary">Contactos excluidos</h1>
          <p className="text-txt-secondary mt-1">Números que el bot ignora — empleados, distribuidores, proveedores</p>
        </div>
        <button
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border-subtle">
                  ...
                  <th className="text-left px-6 py-4 text-xs font-semibold text-txt-tertiary uppercase tracking-wider">Agregado</th>
